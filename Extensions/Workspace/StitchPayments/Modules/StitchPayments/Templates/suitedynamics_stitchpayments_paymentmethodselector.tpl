...
<div class="order-wizard-paymentmethod-selector-module">
	...
	{{#if activeModulesLengthGreaterThan1}}
		...
		{{#if showLogos}}
		<div id="order-wizard-paymentmethod-selector-module-cc-image-container" class="order-wizard-paymentmethod-selector-module-cc-image-container">
			<img class="order-wizard-paymentmethod-selector-module-cc-image" src="{{visaImg}}">
			<img style="position: relative; top: 1px;" class="order-wizard-paymentmethod-selector-module-cc-image" src="{{masterImg}}">
			<img class="order-wizard-paymentmethod-selector-module-cc-image" src="{{americanImg}}">
		</div>
		{{/if}}
