	...
	)
{
	...
	,	setStitchPaymentMethod: function ()
		{
			...
			console.log('set stitch method 3', this)
	...
	,	setActive: function(paymentSelected)
	{
		...
		//Order information
		modelSelected.set('amount', this.model.get('summary').total * 100);
		...
		console.log('set active after SELECTOR', modelSelected)
	}
	...
	,	changeStitchPayment: function(e)
	{
		...
		console.log('Change Payment Method',e)
	...
	,	getContext: function ()
	{
		console.log('stitch logo', this)
		return {

			imageUrl: this.options.images[0],
