	...
	)
{
	...
	return  {
		...
		// 		context.isStitch = this.selectedModule.name == "Stitch" ? true : false

		// 		var stitchModule = _.findWhere(context.activeModules,{ name: 'Stitch' })
		// 		console.log('stitchmodule', context)
		// 		stitchModule.isStitch = true;
		// 		stitchModule.imagesrc =  _.findWhere(this.modules,{ name: 'Stitch' }).imageUrl

		// 		context.imagesrc = _.findWhere(this.modules,{ name: 'Stitch' }).imageUrl;
		// 		context.americanImg = '/img/american.png'
		// 		context.visaImg = '/img/visa.png'
		// 		context.masterImg = '/img/master.png'


		// 		var activeModule = _.findWhere(context.activeModules,{ isSelected: true })
		// 		console.log('stitchmodule', activeModule)
		// 		if(activeModule.name == 'Stitch'){
		// 			context.showLogos = true;
		// 		}else{
		// 			context.showLogos = false;
		// 		}
