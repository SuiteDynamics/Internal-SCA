        ...
        define("MotusPayments.Model",  [
            ...
            return SCModel.extend({
                ...
                getTokens: function()
                {
                    ...
                    var oauthResp = this.getOauthToken(this.getMotusCredentials())
                    ...
                    var response = nlapiRequestURL('https://api.sandbox.paytrace.com/v1/payment_fields/token/create', null, headerObj, 'POST')
                ...
                submitToken: function(data){
                    ...
                    if(motusProfileSubmit.status == 'Success'){
                        try{    
                            ...
                            // var fields = [
                            //     'custrecord_motus_cc_token_exp_month',
                            //     'custrecord_motus_cc_token_exp_year',
                            //     'custrecord_sd_motus_cc_last_4',
                            //     'custrecord_motus_cus_prof_id'
                            // ];
                        
                            // var values = [
                            //     cardDetails.response.customers[0].credit_card.expiration_month,
                            //     cardDetails.response.customers[0].credit_card.expiration_year,
                            //     cardDetails.response.customers[0].credit_card.masked_number.slice(-4),
                            //     cardDetails.response.customers[0].customer_id
                            // ];
                            // nlapiSubmitField('customrecord_motus_cc_token', tokenRec, fields, values);
                        }catch(e){
                ...
                //(credentials_object,JSON.parse(oauthTokenData.getBody()), data, userId);
