try{
                ...
                define("MotusPayments.Model",  [
                    ...
                    return SCModel.extend({
                        ...
                        getTokens: function()
                        {
                            ...
                            nlapiLogExecution('ERROR', 'BODY', JSON.stringify(oauthResponseBody));
                            nlapiLogExecution('ERROR', 'TOKEN', oauthResponseBody.access_token);
                            ...
                            nlapiLogExecution('ERROR', 'PROTECT TOKEN RESP', JSON.stringify(response));
                        ...
                        submitToken: function(data){
                            ...
                            //nlapiLogExecution('ERROR', 'TOKEN REC CREATED', JSON.stringify(tokenRec));
                            ...
                            nlapiLogExecution('ERROR', 'motusProfileSubmit', JSON.stringify(motusProfileSubmit));
                            if(motusProfileSubmit.status == 'Success'){
                                try{    
                                    ...
                                    nlapiLogExecution('ERROR', 'before', JSON.stringify(cardDetails));
                        ...
                        updateTokens: function(data){
                            nlapiLogExecution('ERROR', 'update', 'update');
                            return {'Test': 'test'};
                        },
                        deleteToken: function(id)
                        {
                            nlapiLogExecution('ERROR', 'deleteToken', id);
                            try{
                                var fields = [
                                    'isinactive'
                                ];
                        ...
                        submitCustomerProfile: function(motusCredentials, oauthToken, data, user, nstokenID){
                            // nlapiLogExecution('ERROR', 'submit', JSON.stringify(data));
                            nlapiLogExecution('ERROR', 'PROFILE_TOKENDataCSC', JSON.stringify(data));
                            nlapiLogExecution('ERROR', 'PROFILE_OAUTHTOKENData', JSON.stringify(oauthToken));
                            ...
                            nlapiLogExecution('ERROR', 'body', JSON.stringify(motusBody));
                            nlapiLogExecution('ERROR', 'motusPaymentsApiUrl', motusPaymentsApiUrl);
                            nlapiLogExecution('ERROR', 'headers', JSON.stringify(headerObj));
                            ...
                            nlapiLogExecution('ERROR', 'RAW_OAUTH_RESPONSE', JSON.stringify(response));
                        ...
                        submitBillingAddress: function(motusCredentials, oauthToken, data){
                            // nlapiLogExecution('ERROR', 'submit', JSON.stringify(data));
                            nlapiLogExecution('ERROR', 'submitBillingAddressdata', JSON.stringify(data));
                            nlapiLogExecution('ERROR', 'submitBillingAddressoauth', JSON.stringify(oauthToken));
                            ...
                            nlapiLogExecution('ERROR', 'submitBillingAddressbody', JSON.stringify(motusBody))
                            //Build header object
                            var headerObj = {
                                'Authorization': oauthToken.token_type + " " + oauthToken.access_token,
                                "Access-Control-Allow-Origin": "*",
                            ...
                            nlapiLogExecution('ERROR', 'body', JSON.stringify(motusBody));
                            nlapiLogExecution('ERROR', 'motusPaymentsApiUrl', motusUpdateCustApiUrl);
                            nlapiLogExecution('ERROR', 'headers', JSON.stringify(headerObj));
                        ...
                        getCardDetails: function(motusProfileSubmit, oauthToken, motusCredentials){
                            // nlapiLogExecution('ERROR', 'submit', JSON.stringify(data));
                            // nlapiLogExecution('ERROR', 'PROFILE_TOKENDataCSC', JSON.stringify(data));
                            nlapiLogExecution('ERROR', 'GETPROFILE_OAUTHTOKENData', JSON.stringify(oauthToken));
                            var motusBody = {
                            ...
                            nlapiLogExecution('ERROR', 'body', JSON.stringify(motusBody));
                            nlapiLogExecution('ERROR', 'motusGEtProfileApiUrl', motusgetProfileApiUrl);
                            nlapiLogExecution('ERROR', 'headers', JSON.stringify(headerObj));
                            // var response = nlapiRequestURL(motusPaymentsApiUrl, body, headerObj)
                            ...
                            // var response = nlapiRequestURL(url, body, header, null, "POST");
                            nlapiLogExecution('ERROR', 'RAW_GETPROFILE_RESPONSE', JSON.stringify(response));
                            var responseBody = JSON.parse(response.getBody());
                        ...
                        processOrder: function(cardData){
                            nlapiLogExecution('ERROR', 'processOrder', JSON.stringify(cardData));
                            var credentials_object = this.getMotusCredentials()
                            if (credentials_object) {
                                var oauthTokenData = this.getOauthToken(credentials_object);
                                nlapiLogExecution('ERROR', 'oauthToken', JSON.stringify(oauthTokenData.getBody()));
                                ...
                                var authReponse = this.getAuthResponse(credentials_object,JSON.parse(oauthTokenData.getBody()),cardData);
                                nlapiLogExecution('ERROR', 'AUTH_RESPONSE_FULL', JSON.stringify(authReponse));
                                var responseBody = JSON.parse(authReponse.getBody());
                                var myresponse_code = authReponse.getCode();
                                nlapiLogExecution('ERROR', 'AUTH_RESPONSE_CODE', JSON.stringify(myresponse_code));
                        ...
                        getOauthToken: function(credentialsObj){
                            ...
                            try {
                                if (credentialsObj) {
                                    ...
                                    nlapiLogExecution('ERROR', 'RAW_OAUTH_BODY', JSON.stringify(urlBase));
                        ...
                        getAuthResponse: function(credentialsObj,tokenData,data){
                            nlapiLogExecution('ERROR', 'AUTH_TOKENData', JSON.stringify(tokenData));
                            nlapiLogExecution('ERROR', 'AUTH_TOKENDataCSC', JSON.stringify(data));
                            nlapiLogExecution('ERROR', 'AUTH_TOKENtype', tokenData.token_type);
                            nlapiLogExecution('ERROR', 'AUTH_TOKENtoken', tokenData.access_token);
                            var response = null;
                            try {
                                var urlBase = "";
                                var uuid;
                                ...
                                nlapiLogExecution('ERROR', 'AUTH_TOKENDataCSCuuid', uuid);
                                ...
                                nlapiLogExecution('ERROR', 'motusPaymentsApiUrl', motusPaymentsApiUrl);
                                nlapiLogExecution('ERROR', 'Auth Header', JSON.stringify(headerObjKeyed));
                                nlapiLogExecution('ERROR', 'requestBodyKeyed', JSON.stringify(requestBodyKeyed));
                                nlapiLogExecution('ERROR', 'base url', urlBase);
                        ...
                        voidAuth: function(auth){
                            if (auth.merchid && auth.retref) {
                                ...
                                nlapiLogExecution('ERROR', 'void requestBody', JSON.stringify(requestBody));
                                ...
                                nlapiLogExecution('ERROR', 'RAW_VOID_RESPONSE', JSON.stringify(voidResponse));
                                var responseBody = JSON.parse(voidResponse.getBody());
                                nlapiLogExecution('ERROR', 'RAW_VOID_RESPONSE_BODY', JSON.stringify(responseBody));
                            }
                        },
                        resetTokenDefaults: function(user,newTokenRec){
                            nlapiLogExecution('ERROR', 'resetTokenDefaults', newTokenRec);
                            var filters = [
                            ...
                            search_results.forEach(function (card) {
                                ...
                                nlapiLogExecution('ERROR', 'remove default card', removeDefaultId);
                        ...
                        getMotusCredentials: function(){
                            ...
                            if(motusCreds.length > 0){
                                for (var i = 0; i < motusCreds.length; i++) {
                                    nlapiLogExecution('ERROR', 'result', motusCreds[i].getValue("custrecord_motus_cred_base_url"));
                            ...
                            nlapiLogExecution('ERROR', 'get credentials', JSON.stringify(result));
                            return result;
                        },
                        updateToken: function(data){
                            if(data.data.submit == true){
                                ...
                                nlapiLogExecution('ERROR', 'put default', data.id);
    ...
    define("SuiteDynamics.MotusPayments.MotusPayments.ServiceController", ["ServiceController", "MotusPayments.Model", "LiveOrder.Model","underscore"], function(
      ...
      return ServiceController.extend({
        ...
        put: function put() {
            nlapiLogExecution('ERROR', 'put', JSON.stringify(this.data));
            //Here we will update the token and submit Authorization
            return MotusPaymentsModel.updateToken(this.data);
        },
        delete: function() {
            nlapiLogExecution('ERROR', 'delete', this.request.getParameter('id'));
    ...
    extensions['SuiteDynamics.ZoneSubscriptions.0.0.1'] = function(extensionName){
      var define = function(moduleName, dependencies, callback) {
          for (var i = 0; i < dependencies.length; i++){
              var dep = dependencies[i];
              if (dep === 'Application' && dep.indexOf(extensionName + '.Plugin!') === -1) {
    ...
    define("SuiteDynamics.ZoneSubscriptions.ZoneSubscriptions.ServiceController", ["ServiceController"], function(
      ServiceController
    ) {
      "use strict";
      return ServiceController.extend({
        name: "SuiteDynamics.ZoneSubscriptions.ZoneSubscriptions.ServiceController",
        // The values in this object are the validation needed for the current service.
        options: {
          common: {}
        },
    ...
    // SuiteDynamics.ZoneSubscriptions.ZoneSubscriptions.js
    // Load all your starter dependencies in backend for your extension here
    // ----------------
    define('SuiteDynamics.ZoneSubscriptions.ZoneSubscriptions'
    ,	[
            'SuiteDynamics.ZoneSubscriptions.ZoneSubscriptions.ServiceController'
        ]
    ,	function (
            ZoneSubscriptionsServiceController
        )
    {
        'use strict';
    });
    };
    extensions['CXExtensibility.CoreContent.1.0.6'] = function(extensionName){
      var define = function(moduleName, dependencies, callback) {
          for (var i = 0; i < dependencies.length; i++){
              var dep = dependencies[i];
              if (dep === 'Application' && dep.indexOf(extensionName + '.Plugin!') === -1) {
    ...
    if(website_id === 3 && key_mapping[website_id]){
    ...
    if(key === '2'){
    try{
        extensions['CXExtensibility.CoreContent.1.0.6']('CXExtensibility.CoreContent.1.0.6');
    ...
    try{
        extensions['SuiteDynamics.ZoneSubscriptions.0.0.1']('SuiteDynamics.ZoneSubscriptions.0.0.1');
        require('SuiteDynamics.ZoneSubscriptions.ZoneSubscriptions');
    }
    catch(error){
        nlapiLogExecution('ERROR', 'ERROR_SSP_LIBRARIES_EXT', JSON.stringify(error));
    }
    ...
    var include_mapping = {
        "3": {
            "2": {
                "shopping": {
                    "templates": [
                        "extensions/shopping-templates_2.js"
                    ],
                    "js": [
                        "javascript/shopping.js",
                        "extensions/shopping_2.js"
                    ],
                    "css": [
                        "extensions/shopping_2.css"
                    ],
                    "translations": {},
                    "core": {},
                    "ie": []
                ...
                "myaccount": {
                    "templates": [
                        "extensions/myaccount-templates_2.js"
                    ],
                    "js": [
                        "javascript/myaccount.js",
                        "extensions/myaccount_2.js"
                    ],
                    "css": [
                        "extensions/myaccount_2.css"
                    ],
                    "translations": {},
                    "core": {},
                    "ie": []
                ...
                "checkout": {
                    "templates": [
                        "extensions/checkout-templates_2.js"
                    ],
                    "js": [
                        "javascript/checkout.js",
                        "extensions/checkout_2.js"
                    ],
                    "css": [
                        "extensions/checkout_2.css"
                    ],
                    "translations": {},
                    "core": {},
                    "ie": []
    ...
    var theme_assets_paths = {
        "2": "extensions/SuiteDynamics/SuiteDynamics_Custom_Theme/1.6.0/"
    };
