                ...
                define("StitchPayments.Model",  [
                    ...
                    return SCModel.extend({
                        ...
                        submitCustomerProfile: function(data, user){
                            nlapiLogExecution('DEBUG', 'submit', JSON.stringify(data));
                            var motusCredentials = this.getStitchCredentials(user)
                            ...
                            var userStitchId = nlapiLookupField('customer', user, 'custentity_profile_id_motus');
                            nlapiLogExecution('DEBUG', 'userStitchId', userStitchId);
                            if(userStitchId !== ""){
                                motusBody.profile = userStitchId;
