...
try{
    ...
    extensions['SuiteCommerce.MapContactInfo.1.1.6'] = function(extensionName){
      var define = function(moduleName, dependencies, callback) {
          for (var i = 0; i < dependencies.length; i++){
              var dep = dependencies[i];
              if (dep === 'Application' && dep.indexOf(extensionName + '.Plugin!') === -1) {
    ...
    try{
        extensions['SuiteCommerce.MapContactInfo.1.1.6']('SuiteCommerce.MapContactInfo.1.1.6');
    ...
    var include_mapping = {
        "3": {
            "11": {
                "shopping": {
                    "templates": [
                        "extensions/shopping-templates_11.js"
                    ],
                    "js": [
                        "javascript/shopping.js",
                        "extensions/shopping_11.js"
                    ],
                    "css": [
                        "extensions/shopping_11.css"
                    ],
                    "translations": {},
                    "core": {},
                    "ie": []
                ...
                "myaccount": {
                    "templates": [
                        "extensions/myaccount-templates_11.js"
                    ],
                    "js": [
                        "javascript/myaccount.js",
                        "extensions/myaccount_11.js"
                    ],
                    "css": [
                        "extensions/myaccount_11.css"
                    ],
                    "translations": {},
                    "core": {},
                    "ie": []
                ...
                "checkout": {
                    "templates": [
                        "extensions/checkout-templates_11.js"
                    ],
                    "js": [
                        "javascript/checkout.js",
                        "extensions/checkout_11.js"
                    ],
                    "css": [
                        "extensions/checkout_11.css"
                    ],
                    "translations": {},
                    "core": {},
                    "ie": []
    ...
    var theme_assets_paths = {
        "11": "extensions/SuiteDynamics/SuiteDynamics_Custom_Theme/1.8.0/"
    };
